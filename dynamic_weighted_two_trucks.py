...
obj_value1 = dyn_multi_opt(data1, [visit1, visit2], distances = distance, ward_name = 'Truck 1', t_name = 'truck1', folder_Path = 'Data/Dynamic Data/Multiple Trucks/2 Trucks/', w1 = W1, w2 = W2, n_done = [0, 0], n_trucks = 2, obj_value=[])
print('\n Ward 1 Done \n')
...
obj_value2 = dyn_multi_opt(data2, [visit1, visit2], distances = distance, ward_name = 'Truck 2', t_name = 'truck2', folder_Path = 'Data/Dynamic Data/Multiple Trucks/2 Trucks/', w1 = W1, w2 = W2, n_done = [0, 0], n_trucks = 2, obj_value=[])
print('\n Ward 2 Done \n')
...
obj_value3 = dyn_multi_opt(data3, [visit1, visit2], distances = distance, ward_name = 'Truck 3', t_name = 'truck3', folder_Path = 'Data/Dynamic Data/Multiple Trucks/2 Trucks/', w1 = W1, w2 = W2, n_done = [0, 0], n_trucks = 2, obj_value=[])
print('\n Ward 3 Done \n')
