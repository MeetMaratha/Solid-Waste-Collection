...
v11 = pd.read_csv(f'Data/Dynamic Data/Multiple Trucks/7 Trucks/Visited Truck 1/visited_truck1_1_{W1}_{W2}.csv')
v12 = pd.read_csv(f'Data/Dynamic Data/Multiple Trucks/7 Trucks/Visited Truck 1/visited_truck1_2_{W1}_{W2}.csv')
v13 = pd.read_csv(f'Data/Dynamic Data/Multiple Trucks/7 Trucks/Visited Truck 1/visited_truck1_3_{W1}_{W2}.csv')
v14 = pd.read_csv(f'Data/Dynamic Data/Multiple Trucks/7 Trucks/Visited Truck 1/visited_truck1_4_{W1}_{W2}.csv')
v15 = pd.read_csv(f'Data/Dynamic Data/Multiple Trucks/7 Trucks/Visited Truck 1/visited_truck1_5_{W1}_{W2}.csv')
v16 = pd.read_csv(f'Data/Dynamic Data/Multiple Trucks/7 Trucks/Visited Truck 1/visited_truck1_6_{W1}_{W2}.csv')
v17 = pd.read_csv(f'Data/Dynamic Data/Multiple Trucks/7 Trucks/Visited Truck 1/visited_truck1_7_{W1}_{W2}.csv')

v21 = pd.read_csv(f'Data/Dynamic Data/Multiple Trucks/7 Trucks/Visited Truck 2/visited_truck2_1_{W1}_{W2}.csv')
v22 = pd.read_csv(f'Data/Dynamic Data/Multiple Trucks/7 Trucks/Visited Truck 2/visited_truck2_2_{W1}_{W2}.csv')
v23 = pd.read_csv(f'Data/Dynamic Data/Multiple Trucks/7 Trucks/Visited Truck 2/visited_truck2_3_{W1}_{W2}.csv')
v24 = pd.read_csv(f'Data/Dynamic Data/Multiple Trucks/7 Trucks/Visited Truck 2/visited_truck2_4_{W1}_{W2}.csv')
v25 = pd.read_csv(f'Data/Dynamic Data/Multiple Trucks/7 Trucks/Visited Truck 2/visited_truck2_5_{W1}_{W2}.csv')
v26 = pd.read_csv(f'Data/Dynamic Data/Multiple Trucks/7 Trucks/Visited Truck 2/visited_truck2_6_{W1}_{W2}.csv')
v27 = pd.read_csv(f'Data/Dynamic Data/Multiple Trucks/7 Trucks/Visited Truck 2/visited_truck2_7_{W1}_{W2}.csv')

v31 = pd.read_csv(f'Data/Dynamic Data/Multiple Trucks/7 Trucks/Visited Truck 3/visited_truck3_1_{W1}_{W2}.csv')
v32 = pd.read_csv(f'Data/Dynamic Data/Multiple Trucks/7 Trucks/Visited Truck 3/visited_truck3_2_{W1}_{W2}.csv')
v33 = pd.read_csv(f'Data/Dynamic Data/Multiple Trucks/7 Trucks/Visited Truck 3/visited_truck3_3_{W1}_{W2}.csv')
v34 = pd.read_csv(f'Data/Dynamic Data/Multiple Trucks/7 Trucks/Visited Truck 3/visited_truck3_4_{W1}_{W2}.csv')
v35 = pd.read_csv(f'Data/Dynamic Data/Multiple Trucks/7 Trucks/Visited Truck 3/visited_truck3_5_{W1}_{W2}.csv')
v36 = pd.read_csv(f'Data/Dynamic Data/Multiple Trucks/7 Trucks/Visited Truck 3/visited_truck3_6_{W1}_{W2}.csv')
...
v16.Node = v16.Node.astype('int')
v17.Node = v17.Node.astype('int')
...
v26.Node = v26.Node.astype('int')
v27.Node = v27.Node.astype('int')
...
for i in range(len(v16) - 1):
    path16.append((v16.iloc[i, 0], v16.iloc[i + 1, 0]))
for i in range(len(v17) - 1):
    path17.append((v17.iloc[i, 0], v17.iloc[i + 1, 0]))
...
for i in range(len(v26) - 1):
    path26.append((v26.iloc[i, 0], v26.iloc[i + 1, 0]))
for i in range(len(v27) - 1):
    path27.append((v27.iloc[i, 0], v27.iloc[i + 1, 0]))
...
for i in range(len(v36) - 1):
    path36.append((v36.iloc[i, 0], v36.iloc[i + 1, 0]))
...
gar16 = v16.iloc[-1,1]*10
gar17 = v17.iloc[-1,1]*10
...
gar26 = v26.iloc[-1,1]*10
gar27 = v27.iloc[-1,1]*10
...
dist14 = sum([distance.iloc[i,j] for i,j in path14])/1000
dist15 = sum([distance.iloc[i,j] for i,j in path15])/1000
dist16 = sum([distance.iloc[i,j] for i,j in path16])/1000
dist17 = sum([distance.iloc[i,j] for i,j in path17])/1000
...
dist24 = sum([distance.iloc[i,j] for i,j in path24])/1000
dist25 = sum([distance.iloc[i,j] for i,j in path25])/1000
dist26 = sum([distance.iloc[i,j] for i,j in path26])/1000
dist27 = sum([distance.iloc[i,j] for i,j in path27])/1000
...
dist34 = sum([distance.iloc[i,j] for i,j in path34])/1000
dist35 = sum([distance.iloc[i,j] for i,j in path35])/1000
dist36 = sum([distance.iloc[i,j] for i,j in path36])/1000
...
stats = pd.DataFrame(
    {
        ...
        'Garbage Fill Ward 1 (in Litres)' : [
            ...
            round(gar16/10 * B_TO_B, 4),
            round(gar17/10 * B_TO_B, 4),
            '-'],
        ...
        'Garbage per Meter Ward 1 (in KG/m)' : [
            ...
            round(gar16/dist16, 4),
            round(gar17/dist17, 4),
            '-'],
        'Percentage of Bins covered Ward 1 (in %)' : [
            ...
            round( 100 * (v16.shape[0] - 2)/ data[data.Ward == 0].shape[0], 4),
            round( 100 * (v17.shape[0] - 2)/ data[data.Ward == 0].shape[0], 4),
        ...
        'Garbage Fill Ward 2 (in Litres)' : [
            ...
            round(gar26/10 * B_TO_B, 4),
            round(gar27/10 * B_TO_B, 4),
            '-'],
        ...
        'Garbage per Meter Ward 2 (in KG/m)' : [
            ...
            round(gar26/dist26, 4),
            round(gar27/dist27, 4),
            '-'],
        'Percentage of Bins covered Ward 2 (in %)' : [
            ...
            round( 100 * (v26.shape[0] - 2)/ data[data.Ward == 1].shape[0], 4),
            round( 100 * (v27.shape[0] - 2)/ data[data.Ward == 1].shape[0], 4),
        ...
        'Percentage of Bins covered Ward 3 (in %)' : [
            ...
            round( 100 * (v36.shape[0] - 2)/ data[data.Ward == 2].shape[0], 4),
            '-',
...
map = CreateMap()
map.createRoutes('Data/Dynamic Data/Multiple Trucks/7 Trucks/', N_WARDS, N_TRUCKS, W1, W2, Multiple_truck = True)
...
map.saveMap('Data/Dynamic Data/Multiple Trucks/7 Trucks/')
map.displayMap('Data/Dynamic Data/Multiple Trucks/7 Trucks/')