...
obj_value1 = dyn_multi_opt(data1, [visit1, visit2, visit3], distances = distance, ward_name = 'Truck 1', t_name = 'truck1', folder_Path = 'Data/Dynamic Data/Multiple Trucks/3 Trucks/', w1 = 0.9, w2 = 0.1, n_done = [0, 0, 0], n_trucks = 3, obj_value=[])
print('\n\n Truck 1 Done \n\n')
...
obj_value2 = dyn_multi_opt(data2, [visit1, visit2, visit3], distances = distance, ward_name = 'Truck 2', t_name = 'truck2', folder_Path = 'Data/Dynamic Data/Multiple Trucks/3 Trucks/', w1 = 0.9, w2 = 0.1, n_done = [0, 0, 0], n_trucks = 3, obj_value=[])
print('\n\n Truck 2 Done \n\n')
...
obj_value3 = dyn_multi_opt(data3, [visit1, visit2, visit3], distances = distance, ward_name = 'Truck 3', t_name = 'truck3', folder_Path = 'Data/Dynamic Data/Multiple Trucks/3 Trucks/', w1 = 0.9, w2 = 0.1, n_done = [0, 0, 0], n_trucks = 3, obj_value=[])
print('\n\n Truck 3 Done \n\n')
...
path32 = []
path33 = []
v11 = pd.read_csv('Data/Dynamic Data/Multiple Trucks/3 Trucks/Visited Truck 1/visited_truck1_1_0.9_0.1.csv')
v12 = pd.read_csv('Data/Dynamic Data/Multiple Trucks/3 Trucks/Visited Truck 1/visited_truck1_2_0.9_0.1.csv')
v13 = pd.read_csv('Data/Dynamic Data/Multiple Trucks/3 Trucks/Visited Truck 1/visited_truck1_3_0.9_0.1.csv')
v21 = pd.read_csv('Data/Dynamic Data/Multiple Trucks/3 Trucks/Visited Truck 2/visited_truck2_1_0.9_0.1.csv')
v22 = pd.read_csv('Data/Dynamic Data/Multiple Trucks/3 Trucks/Visited Truck 2/visited_truck2_2_0.9_0.1.csv')
v23 = pd.read_csv('Data/Dynamic Data/Multiple Trucks/3 Trucks/Visited Truck 2/visited_truck2_3_0.9_0.1.csv')
v31 = pd.read_csv('Data/Dynamic Data/Multiple Trucks/3 Trucks/Visited Truck 3/visited_truck3_1_0.9_0.1.csv')
v32 = pd.read_csv('Data/Dynamic Data/Multiple Trucks/3 Trucks/Visited Truck 3/visited_truck3_2_0.9_0.1.csv')
v33 = pd.read_csv('Data/Dynamic Data/Multiple Trucks/3 Trucks/Visited Truck 3/visited_truck3_3_0.9_0.1.csv')
