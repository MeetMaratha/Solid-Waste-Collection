...
from static_function import stat_multi_opt
...
visitedNodes = set()
obj_value1 = stat_multi_opt(data1, [visit1, visit2, visit3], distances = distance, ward_name = 'Truck 1', t_name = 'truck1', folder_Path = 'Data/Static Data/', w1 = W1, w2 = W2, n_trucks = N_TRUCKS, t_no = 0)
print('\n Ward 1 Done \n')
...
visitedNodes = set()
obj_value2 = stat_multi_opt(data2, [visit1, visit2, visit3], distances = distance, ward_name = 'Truck 2', t_name = 'truck2', folder_Path = 'Data/Static Data/', w1 = W1, w2 = W2, n_trucks = N_TRUCKS, t_no = 1)
print('\n Ward 2 Done \n')
...
visitedNodes = set()
obj_value3 = stat_multi_opt(data3, [visit1, visit2, visit3], distances = distance, ward_name = 'Truck 3', t_name = 'truck3', folder_Path = 'Data/Static Data/', w1 = W1, w2 = W2, n_trucks = N_TRUCKS, t_no = 2)
print('\n Ward 3 Done \n')
...
v11 = pd.read_csv(f'Data/Static Data/Visited Truck 1/visited_truck1_1_{W1}_{W2}.csv')
v12 = pd.read_csv(f'Data/Static Data/Visited Truck 1/visited_truck1_2_{W1}_{W2}.csv')
v13 = pd.read_csv(f'Data/Static Data/Visited Truck 1/visited_truck1_3_{W1}_{W2}.csv')

v21 = pd.read_csv(f'Data/Static Data/Visited Truck 2/visited_truck2_1_{W1}_{W2}.csv')
v22 = pd.read_csv(f'Data/Static Data/Visited Truck 2/visited_truck2_2_{W1}_{W2}.csv')
v23 = pd.read_csv(f'Data/Static Data/Visited Truck 2/visited_truck2_3_{W1}_{W2}.csv')

v31 = pd.read_csv(f'Data/Static Data/Visited Truck 3/visited_truck3_1_{W1}_{W2}.csv')
v32 = pd.read_csv(f'Data/Static Data/Visited Truck 3/visited_truck3_2_{W1}_{W2}.csv')
v33 = pd.read_csv(f'Data/Static Data/Visited Truck 3/visited_truck3_3_{W1}_{W2}.csv')
...
stats.to_csv('Data/Static Data/Statistics.csv')

print('--------------- GENERATING MAP ----------------------')
# Plotting routes

map = CreateMap()
map.createRoutes('Data/Static Data/', N_WARDS, N_TRUCKS, W1, W2, Multiple_truck = True)
...
map.saveMap('Data/Static Data/')
map.displayMap('Data/Static Data/')