...
visitedNodes = set()
obj_value1 = dyn_multi_opt(data1, [visit1], visitedNodes = visitedNodes, distances = distance, ward_name = 'Truck 1', t_name = 'truck1', folder_Path = 'Data/Dynamic Data/1 Truck/', w1 = W1, w2 = W2, n_done = [0] * N_TRUCKS, n_trucks = N_TRUCKS)
print('\n Ward 1 Done \n')
...
visit1 = pd.DataFrame({'Node': pd.Series(0, dtype='int'), 'fill_ratio': pd.Series(0, dtype='float')})
visitedNodes = set()
obj_value2 = dyn_multi_opt(data2, [visit1], visitedNodes = visitedNodes, distances = distance, ward_name = 'Truck 2', t_name = 'truck2', folder_Path = 'Data/Dynamic Data/1 Truck/', w1 = W1, w2 = W2, n_done = [0] * N_TRUCKS, n_trucks = N_TRUCKS)
print('\n Ward 2 Done \n')
...
visit1= pd.DataFrame({'Node': pd.Series(0, dtype='int'), 'fill_ratio': pd.Series(0, dtype='float')})
visitedNodes = set()
obj_value3 = dyn_multi_opt(data3, [visit1], visitedNodes = visitedNodes, distances = distance, ward_name = 'Truck 3', t_name = 'truck3', folder_Path = 'Data/Dynamic Data/1 Truck/', w1 = W1, w2 = W2, n_done = [0] * N_TRUCKS, n_trucks = N_TRUCKS)
print('\n Ward 3 Done \n')
...
v11 = pd.read_csv(f'Data/Dynamic Data/1 Truck/Visited Truck 1/visited_truck1_1_{W1}_{W2}.csv')

v21 = pd.read_csv(f'Data/Dynamic Data/1 Truck/Visited Truck 2/visited_truck2_1_{W1}_{W2}.csv')

v31 = pd.read_csv(f'Data/Dynamic Data/1 Truck/Visited Truck 3/visited_truck3_1_{W1}_{W2}.csv')
...
stats.to_csv('Data/Dynamic Data/1 Truck/Statistics.csv')
