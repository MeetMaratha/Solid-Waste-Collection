...
#            #     dic = {}
            #     dic['INPUT'] = 'lines'
            #     dic['START_POINT'] = st_point
            #     dic['END_POINT'] = ed_point
            #     print(dic['START_POINT'], dic['END_POINT'])
            # #     x11 = "'" + str(x1[0]) + ', ' + str(x1[1]) + "'"
            # #     x21 = "'" + str(x2[0]) + ', ' + str(x2[1]) + "'"
            # #     print(x11, x21)
            # count = count + 1
...
ddf.to_csv('C:\\Users\\Meet\\Documents\\Internshipdistance.csv', index = False)
# print(ddf.head())