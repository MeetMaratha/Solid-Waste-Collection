...
obj_value1 = dyn_multi_opt(data1, [visit1, visit2, visit3, visit4], distances = distance, ward_name = 'Truck 1', t_name = 'truck1', folder_Path = 'Data/Dynamic Data/Multiple Trucks/4 Trucks/', w1 = 0.9, w2 = 0.1, n_done = [0, 0, 0, 0], n_trucks = 4, obj_value=[])
print('\n\n Truck 1 Done \n\n')
...
obj_value2 = dyn_multi_opt(data2, [visit1, visit2, visit3, visit4], distances = distance, ward_name = 'Truck 2', t_name = 'truck2', folder_Path = 'Data/Dynamic Data/Multiple Trucks/4 Trucks/', w1 = 0.9, w2 = 0.1, n_done = [0, 0, 0, 0], n_trucks = 4, obj_value=[])
print('\n\n Truck 2 Done \n\n')
...
obj_value3 = dyn_multi_opt(data3, [visit1, visit2, visit3, visit4], distances = distance, ward_name = 'Truck 3', t_name = 'truck3', folder_Path = 'Data/Dynamic Data/Multiple Trucks/4 Trucks/', w1 = 0.9, w2 = 0.1, n_done = [0, 0, 0, 0], n_trucks = 4, obj_value=[])
print('\n\n Truck 3 Done \n\n')
