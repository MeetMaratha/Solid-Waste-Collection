...
\begin{figure}[h]
    ...
    \begin{subfigure}{0.5\textwidth}
        \centering
        \includegraphics[width=\linewidth]{../Images/w1.png} % New Image file
        \caption{Obj vs $w_1$}\label{figw1}
    \end{subfigure}%
    \begin{subfigure}{0.5\textwidth}
        \centering
        \includegraphics[width=\linewidth]{../Images/w2.png} % New Image file
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.7]{../Images/distance_VS_garbage_restricted.png} % New Image path
...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|c|c|c|}
        ...
        \hline \multirow{4}{*}{Ward 1} & Truck 1 & 998.8048& 30.52 &32.72  &16.8421\% \\
        ...
        \hline \multirow{4}{*}{Ward 2} & Truck 1 &998.82 &64.74  & 15.43  &14.4144\% \\
        ...
        \hline \multirow{4}{*}{Ward 3} & Truck 1 &999.32  &37.57  &26.60  &15.9574\% \\
...
% Changes End here
We can infer from the above data that the number of trucks falls just short of being able to satisfactorily cover most of the city's bins. It is only able to cover, on an average, 65\% of the total number of bins that need to be collected.
...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|c|c|c|}
        \hline Ward & Truck & Waste (Kg) & Distance (Km) & Waste/Distance & Percent collected \\
        \hline \multirow{4}{*}{Ward 1} & Truck 1 &998.37  &27.39  & 36.45 &17.8947 \\
        ...
        \hline \multirow{4}{*}{Ward 2} & Truck 1 &994.87  &54.85  &18.14  &12.6126 \\
        ...
        \hline \multirow{4}{*}{Ward 3} & Truck 1 &998.95  &37.27  &26.80  &14.89 \\
...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|c|c|c|}
        ...
        \hline \textit{Ward 1} & 11.5789\%& 41.0526\%& 60.0001\%& 69.4737\%& 98.9474\%\\
        \hline \textit{Ward 2} &9.9099\%&32.4324\%&52.2522\%&63.9636\%&72.9728\%\\
        \hline \textit{Ward 3} &11.7021\%&42.5532\%&58.5107\%&65.9574\%&99.9999\%\\
        \hline
    \end{tabular}
\end{table}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.5\textwidth}
        \centering
        \includegraphics[width=\linewidth]{../Images/coverage_VS_number_of_trucks.png} % Image Changed
        \caption{For the entire city}\label{figc1}
    \end{subfigure}%
    \begin{subfigure}{0.5\textwidth}
        \centering
        \includegraphics[width=\linewidth]{../Images/number_of_trucks_VS_bins_visited.png} % Image Changed
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.4]{../Images/Static_Unweighted.png} % Image changed here
    \caption{Routes for 1 truck per ward as calculated by static optimization}\label{fig4}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.4]{../Images/Dynamic_weighted_1_Truck.png} % Image chaged here
