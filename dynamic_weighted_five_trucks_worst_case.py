...
visitedNodes = set()
obj_value1 = dyn_multi_opt(data1, [visit1, visit2, visit3, visit4, visit5], visitedNodes = visitedNodes, distances = distance, ward_name = 'Truck 1', t_name = 'truck1', folder_Path = 'Data/Dynamic Data/Multiple Trucks/Worst case/', w1 = 0.9, w2 = 0.1, n_done = [0, 0, 0, 0, 0], n_trucks = 5, obj_value=[])
print('\n Truck 1 Done \n')
...
visitedNodes = set()
obj_value2 = dyn_multi_opt(data2, [visit1, visit2, visit3, visit4, visit5], visitedNodes = visitedNodes, distances = distance, ward_name = 'Truck 2', t_name = 'truck2', folder_Path = 'Data/Dynamic Data/Multiple Trucks/Worst case/', w1 = 0.9, w2 = 0.1, n_done = [0, 0, 0, 0, 0], n_trucks = 5, obj_value=[])
print('\nTruck 2 Done \n')
...
visitedNodes = set()
obj_value3 = dyn_multi_opt(data3, [visit1, visit2, visit3, visit4, visit5], visitedNodes = visitedNodes, distances = distance, ward_name = 'Truck 3', t_name = 'truck3', folder_Path = 'Data/Dynamic Data/Multiple Trucks/Worst case/', w1 = 0.9, w2 = 0.1, n_done = [0, 0, 0, 0, 0], n_trucks = 5, obj_value=[])
print('\n Truck 3 Done \n')
...
path34 = []
path35 = []
v11 = pd.read_csv('Data/Dynamic Data/Multiple Trucks/Worst case/Visited Truck 1/visited_truck1_1_0.9_0.1.csv')
v12 = pd.read_csv('Data/Dynamic Data/Multiple Trucks/Worst case/Visited Truck 1/visited_truck1_2_0.9_0.1.csv')
v13 = pd.read_csv('Data/Dynamic Data/Multiple Trucks/Worst case/Visited Truck 1/visited_truck1_3_0.9_0.1.csv')
v14 = pd.read_csv('Data/Dynamic Data/Multiple Trucks/Worst case/Visited Truck 1/visited_truck1_4_0.9_0.1.csv')
v15 = pd.read_csv('Data/Dynamic Data/Multiple Trucks/Worst case/Visited Truck 1/visited_truck1_5_0.9_0.1.csv')
v21 = pd.read_csv('Data/Dynamic Data/Multiple Trucks/Worst case/Visited Truck 2/visited_truck2_1_0.9_0.1.csv')
v22 = pd.read_csv('Data/Dynamic Data/Multiple Trucks/Worst case/Visited Truck 2/visited_truck2_2_0.9_0.1.csv')
v23 = pd.read_csv('Data/Dynamic Data/Multiple Trucks/Worst case/Visited Truck 2/visited_truck2_3_0.9_0.1.csv')
v24 = pd.read_csv('Data/Dynamic Data/Multiple Trucks/Worst case/Visited Truck 2/visited_truck2_4_0.9_0.1.csv')
v25 = pd.read_csv('Data/Dynamic Data/Multiple Trucks/Worst case/Visited Truck 2/visited_truck2_5_0.9_0.1.csv')
v31 = pd.read_csv('Data/Dynamic Data/Multiple Trucks/Worst case/Visited Truck 3/visited_truck3_1_0.9_0.1.csv')
v32 = pd.read_csv('Data/Dynamic Data/Multiple Trucks/Worst case/Visited Truck 3/visited_truck3_2_0.9_0.1.csv')
v33 = pd.read_csv('Data/Dynamic Data/Multiple Trucks/Worst case/Visited Truck 3/visited_truck3_3_0.9_0.1.csv')
v34 = pd.read_csv('Data/Dynamic Data/Multiple Trucks/Worst case/Visited Truck 3/visited_truck3_4_0.9_0.1.csv')
v35 = pd.read_csv('Data/Dynamic Data/Multiple Trucks/Worst case/Visited Truck 3/visited_truck3_5_0.9_0.1.csv')
